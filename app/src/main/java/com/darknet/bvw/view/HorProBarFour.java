...
public class HorProBarFour extends View {
...
//    private int bgColor = 0x0000FF;
    ...
    private String mLastText = "1000300BIW";
    private boolean mNeedDrawProgressText = false;

    private int excetionTime = 0;


//    public void setExcetionTime(int excetionTime) {
//        this.excetionTime = excetionTime;
//    }

    public HorProBarFour(Context context) {
        this(context, null);
    }

    public HorProBarFour(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
        contexttt = context;
        initPaint();
...
//        }
     ...
     * @return
     */
    public HorProBarFour setProgressWithAnimation(float progress) {
        mProgress = progress;
        initAnimation();
        return this;
    }
     ...
     * @return
     */
    public HorProBarFour setCurrentProgress(float progress) {

//        if (excetionTime == 1) {
//            progress = 8;
//            textString = formatNum(/*format2Int(*/progress);
////            textPaint.setColor(contexttt.getResources().getColor(R.color._01FCDA));
//            textPaint.setColor(Color.parseColor("#01fcda"));
//            percentTipWidth = (int) (textPaint.measureText(0.0 + "%") + dp2px(10));
//            mProgress = progress;
...
//        } else {
        ...
        textPaint.setColor(contexttt.getResources().getColor(R.color._01FCDA));
        percentTipWidth = (int) (textPaint.measureText(textString + "%") + dp2px(10));
        mProgress = progress <= 10 ? 10 : progress;
        currentProgress = (mProgressWidth) * progress / 100;
        if (currentProgress < dp2px(2) && currentProgress != 0) {
            currentProgress = dp2px(2);
        }
...
//        }
     ...
     * @return
     */
    public HorProBarFour setProgressListener(ProgressListener listener) {
