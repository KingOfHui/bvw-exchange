 ...
 *
 */
public class HorProBarTwo extends View {
...
//    private int bgColor = 0x0000FF;
    ...
    public HorProBarTwo(Context context) {
        this(context, null);
    }

    public HorProBarTwo(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
        contexttt = context;
        initPaint();
...
//        canvas.drawRoundRect(progressRectF, progressRound, progressRound, progressPaint);
    ...
    public void drawInnerText(Canvas canvas){
...
//        }
     ...
     * @return
     */
    public HorProBarTwo setProgressWithAnimation(float progress) {
        mProgress = progress;
        initAnimation();
        return this;
    }
     ...
     * @return
     */
    public HorProBarTwo setCurrentProgress(float progress) {
     ...
     * @return
     */
    public HorProBarTwo setProgressListener(ProgressListener listener) {
