...
public class VerticalProgressBarThree extends View {
    /**
     * 画笔
     */
    ...
    public VerticalProgressBarThree(Context context, AttributeSet attrs,
                               int defStyleAttr) {
    ...
    public VerticalProgressBarThree(Context context) {
        super(context);
        contexttt = context;
        init();
    }
