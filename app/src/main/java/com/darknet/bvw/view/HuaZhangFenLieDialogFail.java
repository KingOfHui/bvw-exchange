...
public class HuaZhangFenLieDialogFail {
...
//    });
    ...
    public void showTips(final Context context, String content, FenLieOrderResponse.FLOrderItemModel orderItemModel) {
        ...
        try {
            ...
            ad.show();
            ad.setContentView(R.layout.dialog_fenlie_fail);
            ...
            TextView kuangchiNum = (TextView) ad.findViewById(R.id.fnelie_kuangchi_num);
            TextView xiaohuiNum = (TextView) ad.findViewById(R.id.fenlie_xiaohui_num);

            Button copyView = (Button) ad.findViewById(R.id.get_url_view);
            ImageView imgView = (ImageView) ad.findViewById(R.id.imgQr);

//            percentView.setText(orderItemModel.getBack_rate());
...
//            jiaoyihaoView.setText(orderItemModel.getTx_hash());
            qukuaiView.setText(orderItemModel.getHeight());
            timeView.setText(orderItemModel.getCreate_at());

            kuangchiNum.setText(orderItemModel.getBack_pool_bvw()+"");
            xiaohuiNum.setText(orderItemModel.getBurn_bvw()+"");
