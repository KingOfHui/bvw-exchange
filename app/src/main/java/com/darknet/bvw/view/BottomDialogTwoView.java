...
public class BottomDialogTwoView {
    private View contentView;
    private Dialog dialog;

    private BottomDialogTwoView() {
    }
    ...
    public static class Builder {
        ...
        public BottomDialogTwoView.Builder setContentView(int layoutId) {
            this.layoutId = layoutId;
            this.contentView = LayoutInflater.from(this.context).inflate(this.layoutId, this.bottomLayout);
            return this;
        }

        public BottomDialogTwoView.Builder setContentView(View contentView) {
            this.contentView = contentView;
            this.bottomLayout.addView(contentView);
            return this;
        }

        public BottomDialogTwoView.Builder setHasAnimation(boolean hasAnimation) {
            this.hasAnimation = hasAnimation;
            return this;
        }

        public BottomDialogTwoView create() {
            BottomDialogTwoView bottomDialog = new BottomDialogTwoView();
