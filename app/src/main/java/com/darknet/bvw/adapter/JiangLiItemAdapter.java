...
public class JiangLiItemAdapter extends BaseAdapter {

    private Context context;

    private List<TopResponse.TopModel> listVals = new ArrayList<>();
...
//    }
    ...
    public JiangLiItemAdapter(Context context) {
...
//    }
    ...
    public void addData(List<TopResponse.TopModel> vals) {
        listVals.clear();
...
//        int positionss = i % listVals.size();
        TopResponse.TopModel tempVal = listVals.get(i);
        ...
        vh.btcView.setText(tempVal.getBonus()+"BTC");
