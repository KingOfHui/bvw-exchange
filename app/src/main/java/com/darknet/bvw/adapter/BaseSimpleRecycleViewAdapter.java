...
import com.darknet.bvw.listener.OnItemClickListener;
import com.darknet.bvw.listener.OnItemLongClickListener;
...
public abstract class BaseSimpleRecycleViewAdapter<M> extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    protected void bindCustomViewHolder(final BaseViewHolder holder, final int position) {
        ...
        bind(holder, mData.get(dataPos), position);
    }

    protected abstract void bind(final BaseViewHolder holder, final M data, int position);
