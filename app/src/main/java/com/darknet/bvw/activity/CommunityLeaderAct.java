...
public class CommunityLeaderAct extends BaseActivity {
        ...
        OkGo.<String>get("https://api.bvw.im/xchain-apileaderPlan/test/performance/1PiKUYfNTNvgfhK2LHSMNKdDtP12Wg6peM")
                ...
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(Response<String> backresponse) {
                        ...
                        Log.d(TAG, ConfigNetWork.JAVA_API_URL + UrlPath.BIW_PERFORMANCE_URL + ":" + backresponse.body());
                        try {
    ...
    private void isLeader() {
        ...
        OkGo.<String>get(ConfigNetWork.JAVA_API_URL + UrlPath.BIW_STATE_URL)
                .tag(this)
                .headers("Chain-Authentication", addressVals + "#" + msg + "#" + signVal)
                .execute(new StringCallback() {
                    @Override
                    public void onSuccess(Response<String> backresponse) {
                        Log.d(TAG, ConfigNetWork.JAVA_API_URL + UrlPath.BIW_STATE_URL + ":" + backresponse.body());
                        try {
                            Gson gson = new Gson();
