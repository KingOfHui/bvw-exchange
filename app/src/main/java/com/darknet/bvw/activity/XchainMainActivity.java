...
public class XchainMainActivity extends BaseActivity {
...
//        Log.e("backVal","signVal="+signVal);
                                ...
                                try {
                                    ...
                                    if(response != null && response.getCode() == 0 ){
                                        ...
                                        if(response.getData() != null && response.getData().getNickname() != null){
                                            UserSPHelper.setParam(XchainMainActivity.this, "nickName", response.getData().getNickname());

                                            if(response.getData().getVip_level() != null && response.getData().getVip_level().equals("1")){
                                                UserSPHelper.setParam(XchainMainActivity.this, "viplever", "1");
                                                Log.e("viplever","....yes...");
                                            }else {
                                                Log.e("viplever","....no...");
                                                UserSPHelper.setParam(XchainMainActivity.this, "viplever", "0");
                                            }
                                        }
                                    }
                                }catch (Exception e){
    ...
    public static void reStart(Context context) {
        Intent intent = new Intent(context, XchainMainActivity.class);
