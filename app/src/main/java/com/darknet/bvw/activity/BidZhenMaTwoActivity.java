...
public class BidZhenMaTwoActivity extends BaseActivity {
    ...
    public void initView() {
        ...
        ridVal = getIntent().getStringExtra("rid");
        ...
        tilteView.setText(getString(R.string.find_bid_xiang_ma));
        ...
        zhenmaView.setText(ridVal);

        Bitmap bitmap = QrCodeUtil.createQRCode(ridVal, 200, 200, null);
        ...
        copyView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ClipData clipData = ClipData.newPlainText(null, ridVal);
                // 把数据集设置（复制）到剪贴板
                clipboard.setPrimaryClip(clipData);
                Toast.makeText(BidZhenMaTwoActivity.this, getResources().getString(R.string.copy_bord_content), Toast.LENGTH_SHORT).show();
                rockAction();
            }
        });
        ...
        saveView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Bitmap bitmap = QrCodeUtil.createQRCode(ridVal, 200, 200, null);
                QrCodeUtil.saveImageToGallery(BidZhenMaTwoActivity.this, bitmap);
            }
        });
    ...
    private void rockAction() {
        TipHelper.Vibrate(BidZhenMaTwoActivity.this, new long[]{200, 300}, false);
    }
}
