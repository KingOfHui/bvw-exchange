...
public class ControllerCover extends BaseCover implements OnTimerUpdateListener, OnTouchGestureListener {
    ...
    public void onReceiverBind() {
        ...
        shareIcon  = findViewById(R.id.tv_controller_share_img);

        mBackIcon.setOnClickListener(mOnClickListener);
        mStateIcon.setOnClickListener(mOnClickListener);
        mSwitchScreen.setOnClickListener(mOnClickListener);
        shareIcon.setOnClickListener(mOnClickListener);
    ...
    private View.OnClickListener mOnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            }else if(i == R.id.tv_controller_share_img){
