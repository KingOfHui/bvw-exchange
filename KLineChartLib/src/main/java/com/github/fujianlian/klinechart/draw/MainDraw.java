...
public class MainDraw implements IChartDraw<ICandle> {
    ...
    private void drawSelector(BaseKLineChartView view, Canvas canvas) {
        ...
        strings.add(context.getResources().getString(R.string.high) + point.getHighPrice());
        strings.add(context.getResources().getString(R.string.low) + point.getLowPrice());
        strings.add(context.getResources().getString(R.string.open) + point.getOpenPrice());
        strings.add(context.getResources().getString(R.string.close) + point.getClosePrice());
