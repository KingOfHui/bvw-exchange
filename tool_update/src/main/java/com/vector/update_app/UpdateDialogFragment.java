...
//                });
    ...
    private void setDialogTheme(int color, int topResId) {
        ...
        mUpdateOkButton.setBackgroundDrawable(DrawableUtil.getDrawable(AppUpdateUtils.dip2px(4, getActivity()), mActivity.getResources().getColor(R.color.theme_green_two)));
        mNumberProgressBar.setProgressTextColor(mActivity.getResources().getColor(R.color.theme_green_two));
        mNumberProgressBar.setReachedBarColor(mActivity.getResources().getColor(R.color.theme_green_two));
        //随背景颜色变化
