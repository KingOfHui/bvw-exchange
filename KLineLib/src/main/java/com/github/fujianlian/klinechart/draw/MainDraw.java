...
/**
 * 主图的实现类 Created by tifezh on 2016/6/14.
 */
...
//        paint.setColor(ContextCompat.getColor(context, R.color.chart_line_background));
        LinearGradient linearGradient = new LinearGradient(0, 0, 0, 700, ContextCompat.getColor(context, R.color.chart_line_white), ContextCompat.getColor(context, R.color.chart_line_background),
    ...
    private void drawSelector(BaseKLineChartView view, Canvas canvas) {
        ...
        strings.add(context.getString(R.string.high) + ":" + point.getHighPrice());
        strings.add(context.getString(R.string.low) + ":" + point.getLowPrice());
        strings.add(context.getString(R.string.open) + ":" + point.getOpenPrice());
        strings.add(context.getString(R.string.close) + ":" + point.getClosePrice());
